  ...
  private_endpoints = merge(
    var.deploy_private_endpoints.blob != null ? {
      "blob-private-endpoint" = {
        name                                    = var.deploy_private_endpoints.blob.name
        ...
        private_service_connection_name         = var.deploy_private_endpoints.blob.private_service_connection_name
      }
    } : {},
    var.deploy_private_endpoints.queue != null ? {
      "queue-private-endpoint" = {
        name                                    = var.deploy_private_endpoints.queue.name
        ...
        private_endpoints_manage_dns_zone_group = var.deploy_private_endpoints.private_endpoints_manage_dns_zone_group
        private_service_connection_name         = var.deploy_private_endpoints.queue.private_service_connection_name
      }
    } : {},
    var.deploy_private_endpoints.file != null ? {
      "file-private-endpoint" = {
        name                                    = var.deploy_private_endpoints.file.name
        ...
        private_endpoints_manage_dns_zone_group = var.deploy_private_endpoints.private_endpoints_manage_dns_zone_group
        private_service_connection_name         = var.deploy_private_endpoints.file.private_service_connection_name
      }
    } : {},
    var.deploy_private_endpoints.table != null ? {
      "table-private-endpoint" = {
        ...
        private_endpoints_manage_dns_zone_group = var.deploy_private_endpoints.private_endpoints_manage_dns_zone_group
        private_service_connection_name         = var.deploy_private_endpoints.table.private_service_connection_name
      }
    } : {},
  )
}
